...
class MAthOperationDemo {
    ...
    public static void main(String[] args) {
        ...
        Argument ten = new Argument(10);
        Argument five = new Argument(5);
        Argument twenty = new Argument(20);
        MathOperation subtract = new Subtraction(ten, five);
        MathOperation divide = new Division(twenty, five);
        MathOperation multiplicate = new Multiplication(subtract, divide);
        System.out.println("Result for expression (10 - 5) * (20 / 5) : " + multiplicate.calculate());
    }
